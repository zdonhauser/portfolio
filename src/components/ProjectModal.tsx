...
export default function ProjectModal({ isOpen, onClose, project, onNextProject, onPreviousProject }: ProjectModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div className="relative bg-gray-900 border border-gray-700 max-w-[98vw] max-h-[98vh] w-full h-full flex flex-col overflow-hidden md:rounded-lg rounded-none">
        ...
        {/* Bottom Details Panel - Mobile Responsive */}
        <div className="flex-shrink-0 bg-gray-800/90 backdrop-blur-sm border-t border-gray-700 md:p-4 p-3">
              ...
              {project.tags && project.tags.length > 0 && (
                <div className="flex flex-wrap gap-1.5">
                  ...
                  {project.tags.length > 4 && (
                    <span className="px-2 py-1 text-xs text-gray-500 border border-gray-700">
                      +{project.tags.length - 4}
                    </span>
                  )}
                </div>
              ...
              <div className="flex flex-col space-y-2">
                {project.githubUrl && (
                  <a
                    ...
                    className="inline-flex items-center justify-center space-x-2 bg-gray-700 hover:bg-gray-600 text-white px-4 py-3 transition-colors tracking-wide uppercase text-xs font-medium w-full"
                  >
                ...
                {project.type === 'external' && project.url && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center space-x-2 bg-white text-black px-4 py-3 hover:bg-gray-200 transition-colors tracking-wide uppercase text-xs font-medium w-full"
                  >
                ...
                {project.type === 'preview' && (
                  <div className="flex items-center justify-center space-x-2 text-gray-400 text-xs uppercase tracking-widest py-2">
